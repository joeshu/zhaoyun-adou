...
'use strict';
const fs = require('fs');
const FILES = ['data', 'save', 'events', 'audio', 'tween', 'merge', 'battle', 'chapter', 'modecfg', 'waves', 'modes', 'building', 'meta', 'roster', 'dailytask', 'actions', 'game'];
...
;(function () {
  ...
  A(zyRecord.kills === 1 && zyRecord.deployments === 1, '群英谱自动记录');
