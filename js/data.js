...
const MAPS = [
  ...
  {   // 2 街亭：中路开阔、两侧侧翼可布置远程；地图周期性给予盾/弓小补充
    name: '街亭', effect: { name: '军情支援', tip: '每15秒获得1名刀兵/弓兵', iv: 15 },
    PATH_P: [[16, 336], [187, 336], [358, 336], [358, 400], [187, 400], [16, 400], [16, 460], [187, 460], [187, 518]],
    PATH_E: [[16, 244], [187, 244], [358, 244], [358, 186], [187, 186], [16, 186], [16, 124], [187, 124], [187, 72]],
    ROWS_P: [356, 416], ROWS_E: [226, 166],
    COLS: [40, 127, 187, 247, 334],
    ADOU_P: { x: 187, y: 536 }, ADOU_E: { x: 187, y: 58 },
    open: [1, 2, 3, 6, 7, 8],
  },
  {   // 3 函谷关：单行窄路、阿斗偏左，依赖近战与盾兵封路
    name: '函谷关', effect: { name: '险关壁垒', tip: '棋盘驻守单位每12秒获得2点护盾', iv: 12 },
    PATH_P: [[28, 370], [187, 370], [347, 370], [347, 440], [187, 440], [28, 440], [28, 510], [187, 510], [187, 530]],
    PATH_E: [[28, 220], [187, 220], [347, 220], [347, 155], [187, 155], [28, 155], [28, 88], [187, 88], [187, 60]],
    ROWS_P: [388, 452], ROWS_E: [194, 130],
    COLS: [48, 117, 187, 257, 326],
    ADOU_P: { x: 64, y: 536 }, ADOU_E: { x: 64, y: 58 },
    open: [0, 1, 2, 5, 6, 7],
  },
];
