...
const MAPS = [
  {   // 0 长坂坡：路径沿左折再横穿下半，不从格子上走
    name: '长坂坡', effect: { name: '百姓补给', tip: '每18秒双方获得馒头补给', iv: 18 },
    PATH_P: [[12, 324], [340, 324], [340, 448], [12, 448], [12, 460], [187, 460], [187, 506]],
    PATH_E: [[12, 258], [340, 258], [340, 134], [12, 134], [12, 90], [187, 90], [187, 54]],
    ROWS_P: [346, 396, 440], ROWS_E: [222, 178, 138],
    COLS: [51, 119, 187, 255, 323],
    ADOU_P: { x: 187, y: 472 }, ADOU_E: { x: 187, y: 48 },
    open: [1, 2, 3, 6, 7, 8],   // 原开放格索引（3行×5列）
  },
  {   // 1 赤壁：简化为三折线（不穿棋盘），4行布阵在路径上方，水势减速作机制区分
    name: '赤壁', effect: { name: '江风水势', tip: '每18秒水势减缓双方敌军', iv: 18 },
    PATH_P: [[16, 340], [358, 340], [358, 440], [187, 440], [187, 506]],
    PATH_E: [[16, 242], [358, 242], [358, 142], [187, 142], [187, 54]],
    ROWS_P: [346, 384, 420, 456], ROWS_E: [228, 192, 154, 118],
    COLS: [40, 108, 187, 266, 334],
    ADOU_P: { x: 187, y: 472 }, ADOU_E: { x: 187, y: 44 },
     openRowsP: 2, openRowsE: 2, // 敌我前2行全开（4行×5列=20格，开10格）
  },
  {   // 2 街亭：横线+斜线汇入阿斗，不穿过两行布阵格
    name: '街亭', effect: { name: '军情支援', tip: '每15秒获得1名刀兵/弓兵', iv: 15 },
    PATH_P: [[16, 306], [187, 306], [358, 306], [358, 360], [16, 360], [16, 460], [187, 460], [187, 506]],
    PATH_E: [[16, 274], [187, 274], [358, 274], [358, 226], [16, 226], [16, 130], [187, 130], [187, 54]],
    ROWS_P: [316, 380], ROWS_E: [248, 190],
    COLS: [40, 127, 187, 247, 334],
    ADOU_P: { x: 187, y: 472 }, ADOU_E: { x: 187, y: 48 },
    open: [1, 2, 3, 6, 7, 8],
  },
  {   // 3 函谷关：窄路沿左侧折下再汇入偏左下角的阿斗
    name: '函谷关', effect: { name: '险关壁垒', tip: '棋盘驻守单位每12秒获得2点护盾', iv: 12 },
    PATH_P: [[24, 320], [24, 460], [187, 460], [187, 506]],
    PATH_E: [[24, 260], [24, 120], [187, 120], [187, 54]],
    ROWS_P: [330, 412], ROWS_E: [236, 170],
    COLS: [48, 117, 187, 257, 326],
    ADOU_P: { x: 187, y: 472 }, ADOU_E: { x: 64, y: 48 },
    open: [0, 1, 2, 5, 6, 7],
  },
];
